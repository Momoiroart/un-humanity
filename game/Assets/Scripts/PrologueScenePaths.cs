// UN-HUMANITY — scene paths for Slice 0, in a RUNTIME assembly so both the
// editor setup (PrologueScenes) and the runtime transport (PrologueFlow)
// share one source of truth.

public static class PrologueScenePaths
{
